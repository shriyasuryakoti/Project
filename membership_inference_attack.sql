...
--
-- Host: localhost
-- Generation Time: Sep 08, 2022 at 12:55 PM
...
--
-- Database: `membership_inference_attack`
--
CREATE DATABASE IF NOT EXISTS `membership_inference_attack` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `membership_inference_attack`;
...
(1, 'Kamalesh', 'Kamalesh123@gmail.com', 'Kamalesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '', ''),
...
(76, 'Naive Bayes', '36.10533610533611'),
(77, 'SVM', '36.10533610533611'),
(78, 'KNeighborsClassifier', '28.759528759528756'),
(79, 'Gradient Boosting Classifier', '36.10533610533611');
...
(19, 'No Attack', '60.0'),
(20, 'Poisoning or Causative Attack', '20.0'),
(21, 'Evasion or Adversarial Attack', '20.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_inference_attack_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_inference_attack_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `slno` varchar(3000) NOT NULL,
  ...
  `Flow_Bytes_per_second` varchar(3000) NOT NULL,
  `Flow_Packets_per_second` varchar(3000) NOT NULL,
  `Fwd_Packets_per_second` varchar(3000) NOT NULL,
  `Min_Packet_Length` varchar(3000) NOT NULL,
  `Max_Packet_Length` varchar(3000) NOT NULL,
  `Packet_Length_ean` varchar(3000) NOT NULL,
  `ACK_Flag_Count` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `remote_user_inference_attack_detection`
--

INSERT INTO `remote_user_inference_attack_detection` (`id`, `slno`, `Flow_ID`, `Source_IP`, `Source_Port`, `Destination_IP`, `Destination_Port`, `Protocol`, `Timestamp`, `Flow_Duration`, `Total_Fwd_Packets`, `Total_Length_of_Fwd_Packets`, `Fwd_Packet_Length_Max`, `Fwd_Packet_Length_Min`, `Flow_Bytes_per_second`, `Flow_Packets_per_second`, `Fwd_Packets_per_second`, `Min_Packet_Length`, `Max_Packet_Length`, `Packet_Length_ean`, `ACK_Flag_Count`, `Prediction`) VALUES
(3, 'A1OC93L36EHWWJ', '172.16.0.5-192.168.50.1-62567-22915-17', '172.16.0.5', '62567', '192.168.50.1', '22915', '17', '40:34.6', '5999956', '6', '3096', '516', '516', '516.003784', '1.000007333', '1.000007333', '516', '516', '516', '0', 'Evasion or Adversarial Attack'),
(4, 'A1CLBQQ7A77FSI', '172.16.0.5-192.168.50.1-62829-17499-17', '172.16.0.5', '62829', '192.168.50.1', '17499', '17', '40:42.8', '6000965', '6', '3096', '516', '516', '515.9170233', '0.999839193', '0.999839193', '516', '516', '516', '0', 'Poisoning or Causative Attack'),
(5, 'A1J2FKMZPW32HV', '172.16.0.5-192.168.50.1-40670-3539-17', '172.16.0.5', '40670', '192.168.50.1', '3539', '17', '39:38.7', '3003848', '4', '2064', '516', '516', '687.1186558', '1.331625302', '1.331625302', '516', '516', '516', '0', 'No Attack'),
(6, 'A1J2FKMZPW32HV', '172.16.0.5-192.168.50.1-40670-3539-17', '172.16.0.5', '40670', '192.168.50.1', '3539', '17', '39:38.7', '3003848', '4', '2064', '516', '516', '687.1186558', '1.331625302', '1.331625302', '516', '516', '516', '0', 'No Attack'),
(7, 'A2SPYTCUM93BPO', '172.16.0.5-192.168.50.1-62721-48509-17', '172.16.0.5', '62721', '192.168.50.1', '48509', '17', '40:57.7', '2999449', '4', '2064', '516', '516', '688.1263859', '1.333578267', '1.333578267', '516', '516', '516', '0', 'No Attack');
